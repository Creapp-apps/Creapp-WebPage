              ...
              <div id="page-legal" style={{
                ...
                <div style={{
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '2px', alignItems: 'flex-start' }}>
                    ...
                    <span style={{ fontSize: '11px', fontWeight: '800', color: brandPrimary, letterSpacing: '1.2px', lineHeight: '1' }}>{proposal.hero_title ? proposal.hero_title.toUpperCase() : 'DEVELOPMENT LAB'}</span>
                  </div>
                  <span style={{ fontSize: '11px', color: '#94a3b8', letterSpacing: '1px', fontWeight: 'bold', fontFamily: 'monospace' }}>
                    LEGAL_AGREEMENT // 05
                  </span>
                ...
                <div style={{
                  ...
                  <div style={{ borderLeft: `3px solid ${brandPrimary}`, paddingLeft: '8px' }}>
                    <span style={{ fontSize: '10.5px', fontWeight: '900', color: brandPrimary, textTransform: 'uppercase', display: 'block' }}>Hito 1 · Anticipo Inicial ({halfFormatted})</span>
                  ...
                  <div style={{ borderLeft: '3px solid #0f172a', paddingLeft: '8px' }}>
                    <span style={{ fontSize: '10.5px', fontWeight: '900', color: '#0f172a', textTransform: 'uppercase', display: 'block' }}>Hito 2 · Pase a Producción ({halfFormatted})</span>
                    <p style={{ fontSize: '10px', color: '#334155', margin: '2px 0 0 0', lineHeight: '1.35', fontWeight: '500' }}>
                  ...
                  <div style={{ borderLeft: '3px solid #059669', paddingLeft: '8px' }}>
                    <span style={{ fontSize: '10.5px', fontWeight: '900', color: '#059669', textTransform: 'uppercase', display: 'block' }}>Abono Operativo & SLA ({monthlyFeeFormatted})</span>
                    <p style={{ fontSize: '10px', color: '#334155', margin: '2px 0 0 0', lineHeight: '1.35', fontWeight: '500' }}>
                ...
                <div style={{
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                    ...
                    <span style={{ fontSize: '10px', color: '#475569', lineHeight: '1.35' }}>
                      ...
                      Plena validez legal a las firmas digitales conforme a la Ley N° 25.506 y Art. 288 CCCN. Cada suscripción certifica IP, sello temporal UTC y huella criptográfica inmutable.
                    </span>
                  </div>
                  <span style={{
                    fontSize: '9.5px',
                ...
                <div>
                  <div style={{ display: 'flex', gap: '16px' }}>
                    ...
                    <div style={{ flex: '1', display: 'flex', flexDirection: 'column', gap: '2px' }}>
                      <p style={{ fontSize: '9.5px', color: '#94a3b8', letterSpacing: '1px', textTransform: 'uppercase', fontWeight: 'bold', margin: '0 0 2px 0' }}>Por {proposal.client_name}</p>
                      {clientSignature ? (
                        <div style={{ height: '52px', display: 'flex', alignItems: 'center', justifyItems: 'center', justifyContent: 'center', backgroundColor: '#f8fafc', borderRadius: '8px', border: '1px solid #e2e8f0', padding: '4px' }}>
                          <img src={clientSignature} alt="Firma Cliente" style={{ height: '100%', objectFit: 'contain' }} />
                        </div>
                      ...
                      <div style={{ fontSize: '11.5px', marginTop: '1px' }}>
                        ...
                        <p style={{ color: '#64748b', fontSize: '9.5px', margin: '1px 0 0 0' }}>{clientRole || 'Representante Autorizado'}</p>
